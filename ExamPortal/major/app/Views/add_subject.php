 ...
 <br>
  ...
  <div class="container">
      <div class="d-flex justify-content-center h-100">
        <div class="card">
          <form class="form-horizontal" role="form" method="POST" action="add_subject">
     ...
     <label for="inputSUBJECTNAME" class="control-label"> SUBJECT NAME: </label> 
               <input type="text" class="form-control" id="inputSUBJECTNAME"  name="newsubjectname" required>
<br>
            <button type="submit" name="create_btn" >CREATE</button>  
...
if(isset($_POST['create_btn']))
{
  ...
  $lq="SELECT subjectname FROM scategory WHERE subjectname='$newsubjectname' ";
 ...
 if ($count>0)
    {  
      echo '<script>alert("SUBJECT ALREADY EXISTS. ENTER NEW QUESTION")</script>'; 
       
}
 else
    {
 $q="INSERT INTO scategory (subjectname) VALUES('$newsubjectname')";
        mysqli_query($db,$q);
        
 mysqli_close($db);
  echo '<script>alert("NEW SUBJECT ADDED TO THE LIST")
