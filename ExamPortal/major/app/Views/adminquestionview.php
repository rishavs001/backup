...
<html>
<head>
	<title>ADMIN QUESTION VIEW</title>
...
<br>
      ...
      <div class="col-sm-12" style="background-color:lavender;">
            ...
            <div class="card-header">
                        <h3> VIEW QUESTIONS OF <?php echo $_SESSION['subject'] ?></h3>
            </div>
            <div class="card-body">
 ...
 echo "<td>"; echo "$i"; $i++; echo "</td>";
   ...
   echo "<td>"; echo $cat['opt3']; echo "</td>";
    ...
    echo "<td>"; echo $cat['answer']; echo "</td>";
     echo "<td>";?> <a href="updatequestion?id=<?php echo $row['qid']; ?>">EDIT</a> <?php echo "</td>";
       echo "<td>";?> <a href="delete?id=<?php echo $row['qid']; ?>">DELETE</a> <?php echo "</td>";
   echo "</tr>";
