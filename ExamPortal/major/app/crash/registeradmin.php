   ...
   if ($password==$cpassword)
    {  
      ...
      // $password=md5($password);
        $q="INSERT INTO admin (address,mobile,email,password,name) VALUES('$address','$mobile','$email','$password','$name')";
        mysqli_query($db,$q);
         echo '<script>alert("YOU ARE NOW REGISTERED AS AN ADMIN")</script>'; 
  ...
  color: lightcoral;
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="card">
        <form data-toggle="validator" role="form" method="POST" action="registeradmin">
           ...
           <div class= "form-group">
            ...
            <div class="card-footer">
                        <p>Already an ADMIN??</p><a href="loginadmin">LOGIN</a>
                        </div>
            </div>
